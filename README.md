...
My public work spans C#/.NET and PostgreSQL reliability, Rust systems
engineering, human-reviewed AI workflows, and realtime protocol experiments.

`Backend reliability` · `Data consistency` · `Rust systems` · `Realtime protocols` · `Human-governed AI workflows`
